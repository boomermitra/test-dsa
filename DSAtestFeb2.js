...
She was given Q queries. In each query she has index of the array A, X and Y (1<=X, Y<=N, X may be equal to Y) and is ask to find how many positive values of M exists such that after modulating the array with M, AX becomes equal to AY.
